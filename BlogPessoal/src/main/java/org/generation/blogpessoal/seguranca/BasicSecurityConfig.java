...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    @Override //LIBERA ALGUNS CAMINHOS DENTRO DO CONTROLLE, PARA QUE O CLIENTE TENHA ACESSO A ELE, SEM TOKEN
    protected void configure(HttpSecurity htpp) throws Exception {
        ...
        .sessionCreationPolicy(SessionCreationPolicy.STATELESS) //INDICAR QUAL É O TIPO DE SESSÃO QUE VAMOS UTILIZAR
